...
const Hero = () => {
  return (
    <section className="w-full bg-[#F9E4E0]">
      <div className="w-full min-h-560px px-8 md:px-12 lg:px-16 py-12 grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
        ...
        <div className="max-w-620px">
          ...
          <p className="font-['Montserrat'] text-[16px] leading-7 text-[#9CA3AF] mt-6 max-w-560px">
            Experience premium beauty, skincare, nails, and aesthetic treatments
        ...
        <div className="flex justify-center lg:justify-end">
          <div className="relative w-full max-w-560px">
            ...
            <img
              ...
              className="relative z-10 w-full h-360px object-cover object-[65%_center] rounded-[20px] shadow-[0_8px_20px_rgba(0,0,0,0.08)]"
            />
          </div>
        </div>
      </div>
